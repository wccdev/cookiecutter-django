...
-   Media storage using Amazon S3, Google Cloud Storage, Azure Storage, Alibaba Cloud Storage or nginx
...
-   Serve static files from Amazon S3, Google Cloud Storage, Azure Storage, Alibaba Cloud Storage or [Whitenoise](https://whitenoise.readthedocs.io/)
